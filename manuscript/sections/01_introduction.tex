...
\begin{enumerate}
  ...
  \item A batched forward solver that integrates $N$ fibers in
        ...
        a $\sim$\needdata{Y}$\times$ wall-time reduction over
        \texttt{pyfibers} at $N=200$ on a single NVIDIA A100
  ...
  \item An end-to-end differentiable selectivity optimisation pipeline
        ...
        optimum, demonstrated on $N=100$ randomised
        multi-fascicle nerve realisations with a mean selectivity
        index of \needdata{0.97 (Phase 3 placeholder)}
