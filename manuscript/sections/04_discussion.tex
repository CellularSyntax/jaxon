...
vagus-nerve anatomies (Section~\ref{sec:results-duke}), cross-checked
against an independent random-init L1-discovery path designed to rule
out the concern that the probe-based smart initialisation encodes the
answer.  The fibre-model generalisation matters: the same
