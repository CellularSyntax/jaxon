...
\begin{enumerate}
  ...
  \item A demonstration of that pipeline on a cross-species cohort of
        ...
        is cross-validated against an independent random-init
        L1-discovery path to rule out hidden \emph{a priori} bias.
  \item A direct quantification, enabled by simulating the full
        ${\sim}1000$-fibre population rather than a per-fascicle
        centroid, of the selectivity bias introduced by the
