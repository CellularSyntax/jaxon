...
single GPU-vectorized forward pass.  In the central nervous system
...
solver to benchmarking accuracy~\cite{musselman2023}, and selectivity
optimization requires a batched-fiber forward solver that vectorizes
...
differentiability enable selectivity optimization strategies that
