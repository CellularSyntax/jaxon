...
\begin{enumerate}
  ...
  \item A direct quantification, enabled by simulating the full
        ...
        centroid, of the \emph{deployment penalty} incurred when a
        configuration optimised on sparsely-sampled fibres is deployed
        on the full nerve, and of its anatomical driver --- the number
        of fibres per target fascicle --- which we show mediates a
        cross-species gap in transferable selectivity
