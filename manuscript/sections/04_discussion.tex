...
quantifies --- for the first time --- the approximation error
introduced by the centroid-only fibre sampling used in prior
GPU-accelerated work (Section~\ref{sec:results-sparse}).
...
harness, and the selectivity-optimisation pipeline are domain-specific
...
(i) fibre-type (diameter-based) selectivity, exploiting the
