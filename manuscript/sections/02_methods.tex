...
iterations and early-stops when the hard SI reaches $0.95$ (the
experimental selectivity noise floor, beyond which further iterations
are indistinguishable from the $1.0$ ceiling) or when the loss and hard
SI both plateau.  On the histology cohort the trajectory is
